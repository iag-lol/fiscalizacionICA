...
-- Tabla de Detalles de Inspección (relación muchos a muchos entre inspecciones y criterios)
...
-- Índices para InspeccionICA_inspecciones
...
-- Índices para InspeccionICA_detalles_inspeccion
...
-- Índices para InspeccionICA_buses
...
-- Políticas permisivas para lectura pública (ajustar según necesidades de seguridad)
...
-- Políticas para inserción (ajustar según necesidades)
...
-- Insertar terminales de ejemplo
...
-- Insertar criterios de inspección de ejemplo
...
COMMENT ON COLUMN InspeccionICA_inspecciones.estado_general IS 'Estado de la inspección: Pendiente, En Revisión, Solucionada';
COMMENT ON COLUMN InspeccionICA_inspecciones.fecha_ultima_actualizacion_estado IS 'Fecha de la última modificación del estado';
COMMENT ON COLUMN InspeccionICA_detalles_inspeccion.cumple IS 'Si el criterio cumple (true) o no cumple (false)';
